...
use Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact;
...
my $edi = Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact->new(
    { transmission => $invoic } );
my ($msg) = @{ $edi->message_array };
isa_ok( $msg,
    'Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Message',
...
subtest 'shipment_charge sums per plugin shipment_charges_moa_* settings' => sub {
    ...
    my $stub_plugin = sub {
        ...
        bless { _settings => \%settings },
            'Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::TestStub';
    };

    {
        no strict 'refs';
        *{'Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::TestStub::retrieve_data'}
