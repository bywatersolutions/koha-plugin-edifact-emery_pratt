...
my $class = 'Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Segment';
...
subtest 'de_escape removes EDIFACT release character' => sub {
    ...
    my $de_escape = \&Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Segment::de_escape;
