...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt;
use Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Order
        ->new(
        {
